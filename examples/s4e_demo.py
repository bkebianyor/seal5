...
DEST = os.environ.get("DEST", "/space/bkebianyor/seal5_llvm_s4e")
...
if PREPATCHED:
    if seal5_flow.repo is None or "seal5-s4e-stage0" not in seal5_flow.repo.tags:
...
seal5_flow.initialize(
    ...
    clone_ref="seal5-s4e-stage0" if PREPATCHED else "llvmorg-18.1.0-rc3",
